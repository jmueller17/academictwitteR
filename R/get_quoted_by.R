#' Get users who has quoted a tweet
#' 
#' This function fetches users who quoted a tweet
#'
...
#' get_quoted_by(tweets, bearer_token = get_bearer())
#' }
get_quoted_by <- function(x, bearer_token = get_bearer(), data_path = NULL, verbose = TRUE) {
    url <- "https://api.twitter.com/2/tweets/"
    endpoint <- "/quote_tweets"
